...
#define KBRST_SL        (1 << 2)
#define IOXDO_SL        (1 << 4)
#define IOXIO2_SL       (1 << 5)
#define IOXIO1_SL       (1 << 6)
#define IOXLC_SL        (1 << 7)
...
/* ---------------------------------------- */
#define CIRRL_SL        (1 << 3)
#define CIRRM2_SL       (1 << 4)
#define CIRRM1_SL       (1 << 5)
#define SMB3_SL         (1 << 6)
#define SMB4_SL         (1 << 7)
...
/* --------------------------------------- */
#define WD_RST_EN       (1 << 7)
#define GPIO43_POL      (1 << 5)
#define GPIO42_POL      (1 << 4)
#define GPIO_SEL        (3 << 0)
...
/* --------------------------------------- */
#define FPWM_STS        (1 << 7)
#define ADC_TH3_EN      (1 << 2)
#define ADC_TH2_EN      (1 << 1)
#define ADC_TH1_EN      (1 << 0)
...
/* -------------------------------------- */
#define F_SDI_PDE       (1 << 6)

/* Low-Voltage GPIO Pins Control. */
#define LV_GPIO_CTL PORT_BYTE   LV_GPIO_CTL_ADDR
/* ------------------------------------------- */
#define GPIO86_LV       (1 << 7)
#define GPIO85_LV       (1 << 6)
#define GPIO52_LV       (1 << 5)
#define GPIO50_LV       (1 << 4)
#define GPIO44_LV       (1 << 3)
#define GPIO43_LV       (1 << 2)
#define GPIO42_LV       (1 << 1)
#define GPIO02_LV       (1 << 0)

/* Low-Voltage GPIO Pins Control 2. */
#define LV_GPIO_CTL2    PORT_BYTE   LV_GPIO_CTL2_ADDR
/* ------------------------------------------------ */
#define GPIO87_LV       (1 << 7)
#define GPIO62_LV       (1 << 6)
#define GPIO51_LV       (1 << 5)
#define GPIO45_LV       (1 << 4)
#define GPIO15_LV       (1 << 3)
#define GPIO13_LV       (1 << 2)
#define GPIO03_LV       (1 << 1)
#define GPIO01_LV       (1 << 0)

/* Low-Voltage GPIO Pins Control 3. */
#define LV_GPIO_CTL3    PORT_BYTE   LV_GPIO_CTL3_ADDR
/* ------------------------------------------------ */
#define G47_SC4A_LV     (1 << 7)
#define G53_SD4A_LV     (1 << 6)
#define G23_SC3A_LV     (1 << 5)
#define G31_SD3A_LV     (1 << 4)
#define G73_SC2_LV      (1 << 3)
#define G74_SD2_LV      (1 << 2)
#define G17_SC1_LV      (1 << 1)
#define G22_SD1_LV      (1 << 0)
...
/* Core Register Map for ITIM8 */
#define ITIM81_ADDR_BASE 0xFFF700
#define ITIM82_ADDR_BASE 0xFFF710
#define ITIM83_ADDR_BASE 0xFFF720

#define ITCNT1_ADDR     (ITIM81_ADDR_BASE + 0x00)   /* Internal Timer Counter. */
#define ITPRE1_ADDR     (ITIM81_ADDR_BASE + 0x01)   /* Internal Timer Prescaler. */
#define ITCTS1_ADDR     (ITIM81_ADDR_BASE + 0x04)   /* Internal Timer Control and Status. */
#define ITCNT2_ADDR     (ITIM82_ADDR_BASE + 0x00)   /* Internal Timer Counter. */
#define ITPRE2_ADDR     (ITIM82_ADDR_BASE + 0x01)   /* Internal Timer Prescaler. */
#define ITCTS2_ADDR     (ITIM82_ADDR_BASE + 0x04)   /* Internal Timer Control and Status. */
#define ITCNT3_ADDR     (ITIM83_ADDR_BASE + 0x00)   /* Internal Timer Counter. */
#define ITPRE3_ADDR     (ITIM83_ADDR_BASE + 0x01)   /* Internal Timer Prescaler. */
#define ITCTS3_ADDR     (ITIM83_ADDR_BASE + 0x04)   /* Internal Timer Control and Status. */
...
#define N_STEP_RS       N_STEP_RS_ADDR
...
/* ------------------------------------------- */
#define PWMCTL_PWR          (1 << 7)
#define PWMCTL_SYNC         (1 << 4)
#define PWMCTL_CKSEL        (1 << 1)
#define PWMCTL_INVP         (1 << 0)
#define mskINVP3    (1 << 3)        /* Inverse PWM Output */
#define mskINVP2    (1 << 2)        /* Inverse PWM Output */
#define mskINVP1    (1 << 1)        /* Inverse PWM Output */
#define mskINVP0    (1 << 0)        /* Inverse PWM Output */
...
#define TWCFG_WDSDME    (1 << 5)
#define TWCFG_WDCT0I    (1 << 4)
#define TWCFG_LWDCNT    (1 << 3)
#define TWCFG_LTWDT0    (1 << 2)
#define TWCFG_LTECP     (1 << 1)
#define TWCFG_LTWCFG    (1 << 0)
...
/* ---------------------------------------- */
#define ADC_CC0      (1 << 0)        /* Convert Channel 1 */
#define ADC_CC1      (1 << 1)        /* Convert Channel 1 */
#define ADC_CC2      (1 << 2)        /* Convert Channel 1 */
#define ADC_CC3      (1 << 3)        /* Convert Channel 1 */
#define ADC_CC4      (1 << 4)        /* Convert Channel 1 */
#define ADC_CC5      (1 << 5)        /* Convert Channel 1 */
...
/* ---------------------------------------- */
#define DACCTRL_DACEN0 (1 << 0)
#define DACCTRL_DACEN1 (1 << 1)
#define DACCTRL_DACEN2 (1 << 2)
#define DACCTRL_DACEN3 (1 << 3)
#define DACCTRL_ENIDLE (1 << 4)
...
#define SMBnSDA_ADDR        (SMBF_ADDR_BASE + 0x00) /* SMB Serial Data. */
#define SMBnST_ADDR         (SMBF_ADDR_BASE + 0x02) /* SMB Status. */
#define SMBnCST_ADDR        (SMBF_ADDR_BASE + 0x04) /* SMB Control Status. */
#define SMBnCTL1_ADDR       (SMBF_ADDR_BASE + 0x06) /* SMB Control 1. */
#define SMBnADDR1_ADDR      (SMBF_ADDR_BASE + 0x08) /* SMB Own Address 1. */
#define SMBnCTL2_ADDR       (SMBF_ADDR_BASE + 0x0A) /* SMB Control 2. */
#define SMBnADDR2_ADDR      (SMBF_ADDR_BASE + 0x0C) /* SMB Own Address 2. */
#define SMBnCTL3_ADDR       (SMBF_ADDR_BASE + 0x0E) /* SMB Control 3. */
#define SMBnADDR3_ADDR      (SMBF_ADDR_BASE + 0x10) /* SMB Own Address 3. */
#define SMBnADDR7_ADDR      (SMBF_ADDR_BASE + 0x11) /* SMB Own Address 7. */
#define SMBnADDR4_ADDR      (SMBF_ADDR_BASE + 0x12) /* SMB Own Address 4. */
#define SMBnADDR8_ADDR      (SMBF_ADDR_BASE + 0x13) /* SMB Own Address 8. */
#define SMBnADDR5_ADDR      (SMBF_ADDR_BASE + 0x14) /* SMB Own Address 5. */
#define SMBnADDR6_ADDR      (SMBF_ADDR_BASE + 0x16) /* SMB Own Address 6. */
#define SMBnCST2_ADDR       (SMBF_ADDR_BASE + 0x18) /* SMB Control Status 2. */
#define SMBnCST3_ADDR       (SMBF_ADDR_BASE + 0x19) /* SMB Control Status 3. */
#define SMBnCTL4_ADDR       (SMBF_ADDR_BASE + 0x1A) /* SMB Control 4. */
#define SMBnSCLLT_ADDR      (SMBF_ADDR_BASE + 0x1C) /* SMB SCL Low Time. */
#define SMBnFIF_CTL_ADDR    (SMBF_ADDR_BASE + 0x1D) /* SMB FIFO Control. */
#define SMBnSCLHT_ADDR      (SMBF_ADDR_BASE + 0x1E) /* SMB SCL High Time. */
#define SMBnFIF_CTS_ADDR    (SMBF_ADDR_BASE + 0x10) /* SMB FIFO Control and Status. */
#define SMBnTXF_CTL_ADDR    (SMBF_ADDR_BASE + 0x12) /* SMB Tx-FIFO Control. */
#define SMBnT_OUT_ADDR      (SMBF_ADDR_BASE + 0x14) /* SMB Bus Timeout. */
#define SMBnCST2_ADDR       (SMBF_ADDR_BASE + 0x18) /* SMB Control Status 2. */
#define SMBnCST3_ADDR       (SMBF_ADDR_BASE + 0x19) /* SMB Control Status 3. */
#define SMBnTXF_STS_ADDR    (SMBF_ADDR_BASE + 0x1A) /* SMB Tx-FIFO Status. */
#define SMBnRXF_STS_ADDR    (SMBF_ADDR_BASE + 0x1C) /* SMB Rx-FIFO Status. */
#define SMBnRXF_CTL_ADDR    (SMBF_ADDR_BASE + 0x1E) /* SMB Rx-FIFO Control. */
