...
#define FIU_DW_SL              (Enable << 0)
#define ADC_DW_SL              (Enable << 1)
#define PECI_DW_SL             (Disable << 2)
#define OWI_DW_SL              (Enable << 3)
#define SPIP_DW_SL             (Enable << 4)
#define RAM_DW_SL              (Disable << 5)
#define ROM_DW_SL              (Enable << 6)
...
#define PWDWN_CTL1_INIT (KBS_PD_SL | SDP_PD_SL | FIU_PD_SL | PS2_PD_SL \
                            | UART_PD_SL | MFT1_PD_SL | MFT2_PD_SL | MFT3_PD_SL)
...
#define OWI_PD_SL               (Disable << 6)
#define SPIP_PD_SL              (Disable << 7)
