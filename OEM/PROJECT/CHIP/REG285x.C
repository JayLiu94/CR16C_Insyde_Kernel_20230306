...
#define SMBF_PD_SL          (Disable << 4)
#define IOXIF_PD_SL         (Disable << 6)
...
#define DP80_PD_SL                  (Disable << 6)
#define MSWC_PD_SL                  (Disable << 7)
