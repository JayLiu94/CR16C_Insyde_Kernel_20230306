...
/* ---------------------------- DEV_CTL3 OEM Functions ----------------------
      ...
      --- -----------------
       ...
       3  Write-Protect Internal Flash
       4  JTAG Disable, Lock
       5  Reserved
       6  Reserved
       7  Reserved              	*/
...
/* ---------------------------- DEV_CTL4 OEM Functions ----------------------

      Standard definition of DEV_CTL4:

      Bit     Function
      --- -----------------
       0  Pin Flash Select
       1  Reserved
       2  VDD/VeSPI voltage level 
       3  VCC/VeSPI voltage level
       4  Reserved
       5  Reserved
       6  Reserved
       7  Reserved              	*/

#define DEV_CTL4_OEM  0x12

/* ---------------------------- DEV_CTL5 OEM Functions ----------------------         
...
#define SSSPI_SL         (Disable << 3)
#define SCKOUT_SL        (Disable << 2)
#define SSP2I_SL         (Disable << 6)
#define SSP2O_SL         (Disable << 7)
#define DEVALT0_OEM     (SSSPI_SL  | SCKOUT_SL | SSP1I_SL | SSP1O_SL | SSP2I_SL | SSP2O_SL)

/* ---------------------------- DEVALT10 OEM Functions ----------------------

      Standard definition of DEVALT10:
...
#define SKBO4_SL1        (Disable << 0)
#define SKBO9_SL1        (Disable << 1)
#define SKBO10_SL1       (Disable << 2)
#define SKBO11_SL1       (Disable << 3)
#define SKBO12_SL1       (Disable << 4)
#define SKBO13_SL1       (Disable << 5)
#define SKBO14_SL1       (Disable << 6)
#define SKBO15_SL1       (Disable << 7)

#define DEVALT10_OEM (SKBO4_SL1 | SKBO9_SL1 | SKBO10_SL1 | SKBO11_SL1 | SKBO12_SL1 \
                        | SKBO13_SL1 | SKBO14_SL1 | SKBO15_SL1)


/* ---------------------------- DEVALT11 OEM Functions ----------------------

      Standard definition of DEVALT11:
...
#define SGP14_SL       (Disable << 0)
#define SGP07_SL       (Disable << 1)
#define SGP45_SL       (Disable << 2)
#define SGP40_SL       (Disable << 3)
#define SGP00_SL       (Disable << 4)
#define SGP17_SL       (Disable << 5)
#define SGP22_SL       (Disable << 6)
#define SGP74_SL       (Disable << 7)

#define DEVALT11_OEM (SGP14_SL | SGP07_SL | SGP45_SL | SGP40_SL | SGP00_SL \
                         | SGP17_SL | SGP22_SL | SGP74_SL)
...
/* ---------------------------- DEVALT1 OEM Functions ----------------------
      ...
      Bit     Function
      --- -----------------
       0  CR_UART Input 2 Select
       1  CR_UART Input Select
       2  CR_UART Output 1 Select
       3  CR_UART Output 2 Select
       4  SP1 Select
       5  SP2 Select
       6  DPWROK Input Select
       7  CR_UART Output 3 Select 	*/

#define SURTI2_SL      (Disable << 0)
#define SURTI_SL       (Disable << 1)
#define SURTO1_SL      (Disable << 2)
#define SURTO2_SL      (Disable << 3)
#define SSP1CTL_SL     (Disable << 4)
#define SSP2CTL_SL     (Disable << 5)
#define SDPWROK_SL     (Disable << 6)
#define SURTO3_SL      (Disable << 7)

#define DEVALT1_OEM (SURTI_SL | SURTO1_SL | SURTO2_SL | SURTO2_SL | SURTI2_SL \
                        | SDPWROK_SL | SSP1CTL_SL | SSP2CTL_SL)
...
#define DEVALT3_OEM (STA1_SL | STA2_SL | STB1_SL | STB2_SL | STA3_SL | STB3_SL) 
...
#define SSMI2_SL     (Disable << 7)

#define DEVALT4_OEM (SPS2_1_SL | SPS2_2_SL | SPS2_3_SL | SSMI2_SL)
...
#define SKBO7_SL       (Enable << 0)
#define SKBRST_SL      (Enable << 2)
#define SKBRST2_SL     (Disable << 3)
#define SSPI_MOSI_SL   (Disable << 4)
#define SSPI_MISO_SL   (Disable << 5)
#define SSPI_CLK_SL    (Disable << 6)
#define SSPI_CS_SL     (Disable << 7)

#define DEVALT8_OEM (SKBO7_SL | SKBRST_SL | SKBRST2_SL | SSPI_MISO_SL | SSPI_MISO_SL \
                        | SSPI_CLK_SL | SSPI_CS_SL)
...
#define SSMB4_SL      (Enable << 7)
#define DEVALTA_OEM (SSMB3_SL | SSMB4_SL)

/* ---------------------------- DEVALTB OEM Functions ----------------------

      Standard definition of DEVALTB:
...
#define SPD_PWM_SL    (Disable << 1)
#define SRI1_SL       (Disable << 2)
#define SCTS1_SL      (Disable << 3)
#define SRTS1_SL      (Disable << 4)
#define SRI2_SL       (Disable << 5)
#define SCTS2_SL      (Disable << 6)
#define SRTS2_SL      (Disable << 7)

#define DEVALTB_OEM (SPD_PWM_SL | SRI1_SL | SCTS1_SL | SRTS1_SL | SRI2_SL | SCTS2_SL | SRTS2_SL)
...
#define SSMB3B_SL     (Disable << 5)
#define SSMB4B_SL     (Disable << 6)
#define SSMB5_SL      (Disable << 7)

#define DEVALTC_OEM (SSMB3B_SL | SSMB4B_SL | SSMB5_SL)
...
/* ---------------------------- DEVALTD OEM Functions ----------------------
      ...
      --- -----------------
       0  Reserved
       1  Reserved
       2  PSL_IN1 Active High
       3  PSL_IN1 Select
       4  PSL_IN2 Active High
       5  PSL_IN2 Select
       6  Reserved
       7  Reserved           	 */


#define DEVALTD_OEM 0x00
...
/* ---------------------------- DEVALTDX OEM Functions ----------------------
      ...
      --- -----------------
       0  Reserved
       1  Reserved
       2  PSL_IN3 Active High
       3  PSL_IN3 Select     
       4  PSL_IN4 Active High
       5  PSL_IN4 Select     
       6  PSL_GPIO41 Select
       7  PSL_GPIO66_Select  	 */

#define DEVALTDX_OEM 0x00
...
#define DEVALTE_OEM (SVDO2_SL | SVDI2_SL | SVDO1_SL | SVDI1_SL)
...
#define SSMB1_PUE    (Enable << 0)
#define SSMB2_PUE    (Enable << 1)
#define SSMB3_PUE    (Disable << 2)
#define SSMB4A_PUE   (Disable << 3)
#define SSMB4B_PUE   (Disable << 6)
#define SSMB5_PUE    (Disable << 7)

#define DEVPU0_OEM (SSMB1_PUE | SSMB2_PUE | SSMB3_PUE | SSMB4A_PUE | SSMB4B_PUE | SSMB5_PUE)
...
/* ---------------------------- LV_GPIO_CTL0 ----------------------
      ...
      Standard definition of LV_GPIO_CTL0:

      Bit     Function
      --- -----------------
       7  GPIO94 Low-Voltage Select
       6  GPIOB7 Low-Voltage Select
       5  GPIOB1 Low-Voltage Select
       4  GPIO80 Low-Voltage Select
       3  GPIO54 Low-Voltage Select
       2  GPIO40 Low-Voltage Select
       1  GPIO21 Low-Voltage Select
       0  GPIO20 Low-Voltage Select              	*/

#define SGPIO94_LV       (Disable << 7)
#define SGPIOB7_LV       (Disable << 6)
#define SGPIOB1_LV       (Disable << 5)
#define SGPIO80_LV       (Disable << 4)
#define SGPIO54_LV       (Disable << 3)
#define SGPIO40_LV       (Disable << 2)
#define SGPIO21_LV       (Disable << 1)
#define SGPIO20_LV       (Disable << 0)


#define LV_GPIO_CTL0_OEM (SGPIO94_LV | SGPIOB7_LV | SGPIOB1_LV | SGPIO80_LV \
                            | SGPIO54_LV | SGPIO40_LV | SGPIO21_LV | SGPIO20_LV)
...
#define LV_GPIO_CTL1_OEM (SGPIO86_LV | SGPIO85_LV | SGPIO52_LV | SGPIO50_LV \
...
/* ---------------------------- LV_GPIO_CTL3 ----------------------
      ...
      Bit     Function
      --- -----------------
       0  SG22_SD1_LV Low-Voltage Select
       1  SG17_SC1_LV Low-Voltage Select
       2  SG74_SD2_LV Low-Voltage Select
       3  SG73_SC2_LV Low-Voltage Select
       4  SG31_SD3A_LV Low-Voltage Select
       5  SG23_SC3A_LV Low-Voltage Select
       6  SG53_SD4A_LV Low-Voltage Select
       7  SG47_SC4A_LV Low-Voltage Select              	*/
...
#define P00DIR  (Disable << 0)
#define P01DIR  (Disable << 1)    
#define P02DIR  (Disable << 2)
#define P03DIR  (Disable << 3)
#define P04DIR  (Disable << 4)
#define P05DIR  (Disable << 5)
#define P06DIR  (Disable << 6)
#define P07DIR  (Disable << 7)    
    
#define P0DIR_INIT   (P00DIR | P01DIR | P02DIR | P03DIR | P04DIR | P05DIR | P06DIR | P07DIR)
/* -------------------------- P0PULL -------------------------
...
#define P10DIR  (Disable << 0)
#define P11DIR  (Disable << 1)
#define P12DIR  (Enable  << 2)
#define P13DIR  (Disable << 3)
#define P14DIR  (Disable << 4)
#define P15DIR  (Enable  << 5)
#define P16DIR  (Disable << 6)
#define P17DIR  (Disable << 7)

#define P1DIR_INIT  (P10DIR | P11DIR | P12DIR | P13DIR | P14DIR | P15DIR | P16DIR | P17DIR)
/* -------------------------- P1PULL -------------------------
...
/* Device Alternate Function #B Register. */
#define DEVALTB_INIT    DEVALTB_OEM
/* Device Alternate Function #C Register. */
#define DEVALTC_INIT    DEVALTC_OEM
/* Device Alternate Function #D Register. */
#define DEVALTD_INIT    DEVALTD_OEM
/* Device Alternate Function #DX Register. */   
#define DEVALTDX_INIT   DEVALTDX_OEM            
/* Device Alternate Function #E Register. */
#define DEVALTE_INIT    DEVALTE_OEM
/* Device Alternate Function #10 Register. */
#define DEVALT10_INIT   DEVALT10_OEM
/* Device Alternate Function #11 Register. */
#define DEVALT11_INIT   DEVALT11_OEM
...
#define LV_GPIO_CTL0_INIT     LV_GPIO_CTL0_OEM
/* Low-Voltage GPIO Pins Control Register */
#define LV_GPIO_CTL1_INIT     LV_GPIO_CTL1_OEM
...
#define LP_WK_CTL_SL           (Disable << 6)
#define ADC_LFSL_SL            (Disable << 7)

#define ENIDL_CTL_INIT       (ADC_ACC_DIS_SL | PECI_ENIP_SL | LP_WK_CTL_SL | ADC_LFSL_SL)
...
#define DISWT_CTL_INIT      (FIU_DW_SL | ADC_DW_SL | PECI_DW_SL | SPIP_DW_SL \
                                | RAM_DW_SL | ROM_DW_SL | ACC_DW_SL)
...
#define CB_DW_SL                (Enable << 0)
#define CR_LPW_SL               (Enable << 1)
#define SHM_ACC_DW_SL           (Disable << 7)

#define DISWT_CTL1_INIT      (CB_DW_SL | CR_LPW_SL | SHM_ACC_DW_SL)
...
#define SDP_PD_SL               (Enable << 1)
#define FIU_PD_SL               (Enable << 2)
#define PS2_PD_SL               (Disable << 3)
#define UART_PD_SL              (Enable << 4)
#define MFT1_PD_SL              (Disable << 5)
#define MFT2_PD_SL              (Disable << 6)
#define MFT3_PD_SL              (Disable << 7)

#define PWDWN_CTL1_INIT (KBS_PD_SL | SDP_PD_SL | FIU_PD_SL | PS2_PD_SL | UART_PD_SL \
                            | MFT1_PD_SL | MFT2_PD_SL | MFT3_PD_SL)
...
#define SMB3_PD_SL          (Disable << 2)
#define SMB4_PD_SL          (Disable << 3)
#define SMB5_PD_SL          (Enable << 4)
#define USB_PD_SL           (Enable << 5)

#define PWDWN_CTL3_INIT (0x80 | SMB1_PD_SL | SMB2_PD_SL | SMB3_PD_SL | SMB4_PD_SL \
                            | SMB5_PD_SL | USB_PD_SL)
...
#define PWDWN_CTL4_INIT (ITIM1_PD_SL | ITIM2_PD_SL | ITIM3_PD_SL | ADC_PD_SL \
                            | PECI_PD_SL | SMB_DMA_PD_SL | SPIP_PD_SL)
...
/* ---------------------------- PWDWN_CTL6 ----------------------
      Standard definition of PWDWN_CTL6:

      Bit     Function
      --- -----------------
       0  ITIM8-4 Power-Down
       1  ITIM8-5 Power-Down
       2  ITIM8-6 Power-Down
       3  Reserved
       4  Reserved
       5  Reserved
       6  Reserved
...
#define ITIM4_PD_SL             (Disable << 0)
#define ITIM5_PD_SL             (Disable << 1)
#define ITIM6_PD_SL             (Disable << 2)

#define PWDWN_CTL6_INIT (ITIM4_PD_SL | ITIM5_PD_SL | ITIM6_PD_SL)
...
const REG_INIT_DESCRIPTOR Reg_Init[] =
{
    ...
    { DEVALTB_ADDR,  Byte_type,  DEVALTB_INIT   },      /* Device Alternate Function #B Register. */
    { DEVALTC_ADDR,  Byte_type,  DEVALTC_INIT   },      /* Device Alternate Function #C Register. */
    { DEVALTD_ADDR,  Byte_type,  DEVALTD_INIT   },      /* Device Alternate Function #D Register. */
    { DEVALTDX_ADDR, Byte_type,  DEVALTDX_INIT  },      /* Device Alternate Function #DX Register. */
    { DEVALTE_ADDR,  Byte_type,  DEVALTE_INIT   },      /* Device Alternate Function #E Register. */
    { DEVALT10_ADDR, Byte_type,  DEVALT10_INIT  },      /* Device Alternate Function #10 Register. */
    { DEVALT11_ADDR, Byte_type,  DEVALT11_INIT  },      /* Device Alternate Function #11 Register. */
    ...
    { LV_GPIO_CTL0_ADDR,  Byte_type, LV_GPIO_CTL0_INIT }, /* Low-Voltage GPIO Pins Control 0. */
    { LV_GPIO_CTL1_ADDR,  Byte_type, LV_GPIO_CTL1_INIT }, /* Low-Voltage GPIO Pins Control 1. */
    { LV_GPIO_CTL2_ADDR, Byte_type,  LV_GPIO_CTL2_INIT }, /* Low-Voltage GPIO Pins Control 2. */
    { LV_GPIO_CTL2_ADDR, Byte_type,  LV_GPIO_CTL3_INIT }, /* Low-Voltage GPIO Pins Control 3. */
    ...
    { PWDWN_CTL6_ADDR,  Byte_type,  PWDWN_CTL6_INIT }    /* PWDWN_CTL6 Data. */
};
